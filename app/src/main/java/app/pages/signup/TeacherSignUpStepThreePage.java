...
public class TeacherSignUpStepThreePage extends BasePage {
    ...
    public void selectSchoolFromTheList() {
        TEACHER_SIGNUP_SELECT_SCHOOL_INPUT.sendKeys("school");
    ...
    public void setCustomSchoolName() {
        TEACHER_SIGNUP_CUSTOM_SCHOOL_NAME_INPUT.sendKeys("AutoTestCustomSchool");
    }

    public void setCustomSchoolState() {
        TEACHER_SIGNUP_CUSTOM_SCHOOL_STATE_INPUT.sendKeys("AA Kyiv");
    }
    public void setCustomSchoolPhoneNumber(){
        TEACHER_SIGNUP_CUSTOM_SCHOOL_PHONE_INPUT.sendKeys("+380-999-99-46-00");

    }
    public void setCustomSchoolAddressOne(){
        TEACHER_SIGNUP_CUSTOM_SCHOOL_ADDRESS1_INPUT.sendKeys("Address1 of the autotest custom school, building 1a, 6/8*()");

    }
    public void setCustomSchoolAddressTwo(){
        TEACHER_SIGNUP_CUSTOM_SCHOOL_ADDRESS2_INPUT.sendKeys("Address2 of the autotest custom school, building 1a, 6/8*()");

    }
    public void setCustomSchoolZipCode(){
        TEACHER_SIGNUP_CUSTOM_SCHOOL_ZIP_CODE_INPUT.sendKeys("1234567890FF/GG");

    }

    public void assertConfirmAndContinueButtonIsAble() {
        TEACHER_SIGNUP_CONFIRM_AND_CONTINUE_BUTTON.shouldNotBe(Condition.disabled);
    }
    public void clickOnConfirmAndContinueButtonAsTeacher() {
        TEACHER_SIGNUP_CONFIRM_AND_CONTINUE_BUTTON.click();
    }
