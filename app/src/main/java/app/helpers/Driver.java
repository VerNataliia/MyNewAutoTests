...
abstract public class Driver {
    ...
    public static void takeScreenshot() {
        ...
        String path = System.getProperty("user.dir") + File.separator + "test-output" + File.separator + "screenshots" + File.separator + " " + "screenshot_" + (new SimpleDateFormat("HHmmssSSS").format(new Date())) + ".png";
        try {
    ...
    public void waitForPageLoad() throws InterruptedException {
        ...
        String jsReadyState = "return document.readyState.equals('complete')";
        boolean jsReady = executeJavaScript(jsReadyState);
        if (!jsReady) {
            sleep(1000); // Waits an additional second if the page is not ready
        }
    }
}
